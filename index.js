...
var btnmoinstag=document.getElementsByClassName("moins")
// console.log(btnmoinstag)
for (let index = 0; index < btnmoinstag.length; index++) {
    btnmoinstag[index].addEventListener("click",decriment)
}
function decriment(event) {
    var btnmoins=event.target
    // console.log(btnmoins)
    var divtag=btnmoins.parentElement
    // console.log(divtag)
    var pqte=divtag.querySelector(".qte")
    // console.log(pqte)
    var qtevalue=pqte.innerHTML
...
var trash = document.getElementsByClassName('bx-trash')
//console.log(trash)
...
var likes = document.getElementsByClassName('bxs-heart')
